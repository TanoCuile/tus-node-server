...
class TusServer extends EventEmitter {
    ...
    constructor(options) {
        ...
        if (options !== undefined) {
            if (options.hasOwnProperty('CORS')) {
                this.options.CORS = options.CORS;
            }
    ...
    set datastore(store) {
        ...
        this.handlers = {
            ...
            HEAD: new HeadHandler(store, this.options.https),
            OPTIONS: new OptionsHandler(store, this.options.https),
            PATCH: new PatchHandler(store, this.options.https),
            POST: new PostHandler(store, this.options.https),
        };
    }
